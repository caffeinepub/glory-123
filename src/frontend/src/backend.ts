...
export class Backend implements backendInterface {
    ...
    async checkout(arg0: PaymentMethod): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.checkout(to_candid_PaymentMethod_n1(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
